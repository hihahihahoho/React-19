...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "no-scrollbar inline-flex h-9 max-w-full items-center justify-start overflow-auto overscroll-contain rounded-lg bg-muted p-1 text-muted-foreground",
        className
      )}
...
function TabsTrigger({
  ...
  return (
    ...
    >
      ...
      {activeTab === value && (
        <motion.div
          className="absolute top-0 z-0 h-full w-full rounded-md bg-background shadow"
          layoutId={layoutId}
          transition={{
            duration: 0.2,
            ease: "easeInOut",
