...
function RatingRootImpl(
  props: Omit<RatingRootProps, "defaultValue" | "onValueChange" | "onHover">
) {
  const {
    value,
    id: idProp,
  ...
  const onFocus = React.useCallback(
    ...
    [onFocusProp, isTabbingBackOut, currentValue, tabStopId]
  )
  ...
  const onMouseLeave = React.useCallback(
    ...
    [onMouseLeaveProp, disabled, readOnly, store]
  )
...
function RatingItem(props: RatingItemProps) {
  ...
  const onMouseDown = React.useCallback(
    ...
    [onMouseDownProp, focusContext, itemId, isDisabled]
  )
